...
execute as @s[scores={timer=80,session1=1,session2=0,session3=0,session4=0}] run function secret:session1
execute as @s[scores={timer=80,session1=1,session2=1,session3=0,session4=0}] run function secret:session2
execute as @s[scores={timer=80,session1=1,session2=1,session3=1,session4=0}] run function secret:session3
execute as @s[scores={timer=80,session1=1,session2=1,session3=1,session4=1}] run function secret:session4
