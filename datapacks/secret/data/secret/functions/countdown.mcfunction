...
# Particle effect
execute as @a[scores={timer=80}] run execute at @e[tag=init] run summon experience_orb ~1 ~3 ~
execute as @a[scores={timer=80}] run execute at @e[tag=init] run summon experience_orb ~2 ~3 ~
execute as @a[scores={timer=80}] run execute at @e[tag=init] run summon experience_orb ~3 ~3 ~
execute as @a[scores={timer=80}] run execute at @e[tag=init] run summon experience_orb ~ ~3 ~1
execute as @a[scores={timer=80}] run execute at @e[tag=init] run summon experience_orb ~ ~3 ~2
execute as @a[scores={timer=80}] run execute at @e[tag=init] run summon experience_orb ~ ~3 ~3
