...
execute as @a[scores={timer=1..60}] run particle minecraft:enchant ~ ~5 ~-5 1 1 1 3 3 normal
execute as @a[scores={timer=1..60}] run particle minecraft:dust 0 1 0 1 ~ ~5 ~-5 0.1 0.1 0.1 0.5 8 normal
