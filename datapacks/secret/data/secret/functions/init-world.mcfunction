...
setblock ~-2 ~ ~1 spruce_wall_sign[facing=south]{front_text:{messages:['["Succeed"]'],has_glowing_text:1}}
...
#setblock ~ ~ ~1 minecraft:spruce_wall_sign[facing=south]
setblock ~-2 ~ ~1 spruce_wall_sign[facing=south]{front_text:{messages:['["Reroll for","a harder task"]'],has_glowing_text:1}}
...
setblock ~2 ~-1 ~1 minecraft:reinforced_deepslate
#setblock ~2 ~ ~1 minecraft:spruce_wall_sign[facing=south]
setblock ~-2 ~ ~1 spruce_wall_sign[facing=south]{front_text:{messages:['["Fail"]'],has_glowing_text:1}}
