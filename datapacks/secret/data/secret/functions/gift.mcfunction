...
execute as @s[scores={s1gift=1,session1=1,session2=0,session3=0,session4=0}] run tell @s Heart already given this session!
execute as @s[scores={s2gift=1,session1=1,session2=1,session3=0,session4=0}] run tell @s Heart already given this session!
execute as @s[scores={s3gift=1,session1=1,session2=1,session3=1,session4=0}] run tell @s Heart already given this session!
execute as @s[scores={s4gift=1,session1=1,session2=1,session3=1,session4=1}] run tell @s Heart already given this session!
