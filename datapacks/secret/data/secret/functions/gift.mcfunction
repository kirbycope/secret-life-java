...
execute as @s[scores={s1gift=0,session1=1,session2=0,session3=0,session4=0,session5=0}] run tag @p[distance=0.1..] add gift
...
execute as @s[scores={s2gift=0,session1=1,session2=1,session3=0,session4=0,session5=0}] run tag @p[distance=0.1..] add gift
...
execute as @s[scores={s3gift=0,session1=1,session2=1,session3=1,session4=0,session5=0}] run tag @p[distance=0.1..] add gift
...
execute as @s[scores={s4gift=0,session1=1,session2=1,session3=1,session4=1,session5=0}] run tag @p[distance=0.1..] add gift
...
execute as @s[scores={s5gift=0,session1=1,session2=1,session3=1,session4=1,session5=1}] run tag @p[distance=0.1..] add gift
