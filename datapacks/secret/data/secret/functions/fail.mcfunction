...
execute as @a[scores={timer=1..60}] run particle minecraft:dust 1 0 0 1 ~-2 ~5 ~-5 0.1 0.1 0.1 0.5 8 normal
...
execute as @a[scores={timer=1..60}] run particle minecraft:dust 1 0 0 1 ~-1 ~7 ~-5 0.1 0.1 0.1 0.5 8 normal
execute as @a[scores={timer=1..60}] run particle minecraft:dust 1 0 0 1 ~1 ~7 ~-5 0.1 0.1 0.1 0.5 8 normal
execute as @a[scores={timer=1..60}] run particle minecraft:dust 1 0 0 1 ~-1 ~8 ~-5 0.1 0.1 0.1 0.5 8 normal
execute as @a[scores={timer=1..60}] run particle minecraft:dust 1 0 0 1 ~1 ~8 ~-5 0.1 0.1 0.1 0.5 8 normal
...
execute as @a[scores={timer=1..60}] run particle minecraft:dust 1 0 0 1 ~2 ~10 ~-5 0.1 0.1 0.1 0.5 8 normal
