...
execute as @s[scores={timer=0,s8fail=0,s8success=0},tag=session8] run tag @s add fail
execute as @s[scores={timer=0,s9fail=0,s9success=0},tag=session9] run tag @s add fail
...
execute as @s[scores={timer=60,s8fail=0,s8success=0},tag=session8] run function secret:fail8
execute as @s[scores={timer=60,s9fail=0,s9success=0},tag=session9] run function secret:fail9
